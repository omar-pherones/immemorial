...
const Hero = () => {
    ...
    useGsapShutterUnveil(shutter1Ref, 0, heroRef);
    useGsapShutterUnveil(shutter2Ref, 0.3, heroRef);
    useGsapPhotoDropping(photosArr);
    useGsapPhotoLevitate(photosArr, heroRef);
    return (
        <section className="hero wraper" ref={heroRef}>
            <div className="hero-content">
                <h1 className="ethereal">
                    Ethereal <span ref={shutter1Ref}></span>
                </h1>
                <h1 className="canvas">
                    Canvas <span ref={shutter2Ref}></span>
                </h1>
            </div>
